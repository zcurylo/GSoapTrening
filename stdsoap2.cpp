...
#ifdef WIN32
	    m = 0;
        //wctomb_s(&m, buf, sizeof(buf), (wchar_t)(c & 0x7FFFFFFF)); ZCU we do not have secure version of stdlib.
        m = wctomb(buf, (wchar_t)(c & 0x7FFFFFFF)); // ZCU
#else
...
#ifdef WIN32
	  m = 0;
      //wctomb_s(&m, buf, sizeof(buf), (wchar_t)(c & 0x7FFFFFFF));  we do not have secure version of stdlib.
      m = wctomb(buf, (wchar_t)(c & 0x7FFFFFFF)); //ZCU
#else
	  m = wctomb(buf, (wchar_t)(c & 0x7FFFFFFF));
#endif
